...
- [yAcademy Superfluid review](#yacademy-superfluid-review)
	...
	- [Residents Low Findings](#residents-low-findings)
		- [1. Low - `decodeCtx()` missing error checks (engn33r)](#1-low---decodectx-missing-error-checks-engn33r)
			- [Technical Details](#technical-details)
			- [Impact](#impact)
			- [Recommendation](#recommendation)
			- [Developer Response](#developer-response)
		- [2. Low - No function to unregister an agreement class (engn33r)](#2-low---no-function-to-unregister-an-agreement-class-engn33r)
			- [Technical Details](#technical-details-1)
			- [Impact](#impact-1)
			- [Recommendation](#recommendation-1)
			- [Developer Response](#developer-response-1)
		- [3. Low - App registration front-running can set a different `configword` (engn33r)](#3-low---app-registration-front-running-can-set-a-different-configword-engn33r)
			- [Technical Details](#technical-details-2)
			- [Impact](#impact-2)
			- [Recommendation](#recommendation-2)
			- [Developer Response](#developer-response-2)
		- [4. Low - `appCallbackPop()` missing modifier (engn33r, NibblerExpress)](#4-low---appcallbackpop-missing-modifier-engn33r-nibblerexpress)
	...
	- [Residents Gas Savings Findings](#residents-gas-savings-findings)
		- [1. Gas - Unnecessary zero initialization (engn33r)](#1-gas---unnecessary-zero-initialization-engn33r)
			- [Technical Details](#technical-details-4)
			- [Impact](#impact-4)
			- [Recommendation](#recommendation-4)
			- [Developer Response](#developer-response-4)
		- [2. Gas - Avoid && logic in require statements (engn33r)](#2-gas---avoid--logic-in-require-statements-engn33r)
			- [Technical Details](#technical-details-5)
			- [Impact](#impact-5)
			- [Recommendation](#recommendation-5)
			- [Developer Response](#developer-response-5)
		- [3. Gas - Use != 0 for gas savings (engn33r)](#3-gas---use--0-for-gas-savings-engn33r)
		...
		- [5. Gas - External functions are cheaper than public functions (engn33r)](#5-gas---external-functions-are-cheaper-than-public-functions-engn33r)
		...
		- [7. Gas - Use prefix in loops (engn33r)](#7-gas---use-prefix-in-loops-engn33r)
			- [Technical Details](#technical-details-10)
			- [Impact](#impact-10)
			- [Recommendation](#recommendation-10)
			- [Developer Response](#developer-response-10)
		- [8. Gas - Declare constant internal when possible (engn33r)](#8-gas---declare-constant-internal-when-possible-engn33r)
	...
	- [Fellows Gas Savings Findings](#fellows-gas-savings-findings)
		- [1. Gas - Use of `memory` for function arguments (blockdev)](#1-gas---use-of-memory-for-function-arguments-blockdev)
			- [Proof of concept](#proof-of-concept)
			- [Impact](#impact-12)
			- [Recommendation](#recommendation-12)
		- [2. Gas - Unnecessary variable computation (blockdev)](#2-gas---unnecessary-variable-computation-blockdev)
			- [Proof of concept](#proof-of-concept-1)
			- [Impact](#impact-13)
			- [Recommendation](#recommendation-13)
		- [3. Gas - Shorted revert strings (devtooligan)](#3-gas---shorted-revert-strings-devtooligan)
			- [Proof of concept](#proof-of-concept-2)
			- [Impact](#impact-14)
			- [Recommendation](#recommendation-14)
		- [4. Gas - Custom error (devtooligan)](#4-gas---custom-error-devtooligan)
			- [Impact](#impact-15)
			- [Recommendation](#recommendation-15)
		- [5. Gas - Using >0 for unsigned integers (SaharAP)](#5-gas---using-0-for-unsigned-integers-saharap)
			- [Impact](#impact-16)
			- [Recommendation](#recommendation-16)
		- [6. Gas - Unchecked counter incrementation in "for" loop (verypoor)](#6-gas---unchecked-counter-incrementation-in-for-loop-verypoor)
			- [Impact](#impact-17)
			- [Recommendation](#recommendation-17)
	- [Residents Informational Findings](#residents-informational-findings)
		- [1. Informational - Potential underflow condition (engn33r)](#1-informational---potential-underflow-condition-engn33r)
			- [Technical Details](#technical-details-12)
			- [Impact](#impact-18)
			- [Recommendation](#recommendation-18)
			- [Developer Response](#developer-response-12)
		- [2. Informational - Potential hash collision (engn33r)](#2-informational---potential-hash-collision-engn33r)
			- [Technical Details](#technical-details-13)
			- [Impact](#impact-19)
			- [Recommendation](#recommendation-19)
			- [Developer Response](#developer-response-13)
		- [3. Informational - Logic inconsistency between `callAgreementWithContext()` and `callAppActionWithContext()` (engn33r)](#3-informational---logic-inconsistency-between-callagreementwithcontext-and-callappactionwithcontext-engn33r)
			- [Technical Details](#technical-details-14)
			- [Impact](#impact-20)
			- [Recommendation](#recommendation-20)
			- [Developer Response](#developer-response-14)
		- [4. Informational - Upgradable Superfluid.sol has hardcoded version (engn33r)](#4-informational---upgradable-superfluidsol-has-hardcoded-version-engn33r)
			- [Technical Details](#technical-details-15)
			- [Impact](#impact-21)
			- [Recommendation](#recommendation-21)
			- [Developer Response](#developer-response-15)
		- [5. Informational - `_callAppAction()` logic varies from `_callAgreement()` (engn33r)](#5-informational---_callappaction-logic-varies-from-_callagreement-engn33r)
			- [Technical Details](#technical-details-16)
			- [Impact](#impact-22)
			- [Recommendation](#recommendation-22)
			- [Developer Response](#developer-response-16)
		- [6. Informational - Use named cached variable (engn33r)](#6-informational---use-named-cached-variable-engn33r)
			- [Technical Details](#technical-details-17)
			- [Impact](#impact-23)
			- [Recommendation](#recommendation-23)
			- [Developer Response](#developer-response-17)
		- [7. Informational - `_replacePlaceholderCtx()` logic could be simplified (engn33r)](#7-informational---_replaceplaceholderctx-logic-could-be-simplified-engn33r)
			- [Technical Details](#technical-details-18)
			- [Impact](#impact-24)
			- [Recommendation](#recommendation-24)
			- [Developer Response](#developer-response-18)
		- [8. Informational - `_callCallback()` logic can be simplified (engn33r)](#8-informational---_callcallback-logic-can-be-simplified-engn33r)
			- [Technical Details](#technical-details-19)
			- [Impact](#impact-25)
			- [Recommendation](#recommendation-25)
			- [Developer Response](#developer-response-19)
		- [9. Informational - Broken link (engn33r)](#9-informational---broken-link-engn33r)
			- [Technical Details](#technical-details-20)
			- [Impact](#impact-26)
			- [Recommendation](#recommendation-26)
			- [Developer Response](#developer-response-20)
		- [10. Informational - FIXME or TODO comments remain in code (engn33r)](#10-informational---fixme-or-todo-comments-remain-in-code-engn33r)
			- [Technical Details](#technical-details-21)
			- [Impact](#impact-27)
			- [Recommendation](#recommendation-27)
			- [Developer Response](#developer-response-21)
		- [11. Informational - Typos (engn33r)](#11-informational---typos-engn33r)
			- [Technical Details](#technical-details-22)
			- [Impact](#impact-28)
			- [Recommendation](#recommendation-28)
			- [Developer Response](#developer-response-22)
		- [12. Informational - Incorrect external code reference (engn33r)](#12-informational---incorrect-external-code-reference-engn33r)
			- [Technical Details](#technical-details-23)
			- [Impact](#impact-29)
			- [Recommendation](#recommendation-29)
			- [Developer Response](#developer-response-23)
		- [13. Informational - Match callInfo masks and shifts to data size (NibblerExpress)](#13-informational---match-callinfo-masks-and-shifts-to-data-size-nibblerexpress)
			- [Technical Details](#technical-details-24)
			- [Impact](#impact-30)
			- [Recommendation](#recommendation-30)
			- [Developer Response](#developer-response-24)
		- [14. Informational - `isConfigWordClean` doesn't check some unused bits (NibblerExpress)](#14-informational---isconfigwordclean-doesnt-check-some-unused-bits-nibblerexpress)
			- [Technical Details](#technical-details-25)
			- [Impact](#impact-31)
			- [Recommendation](#recommendation-31)
			- [Developer Response](#developer-response-25)
		- [15. Informational - Remove unnecessary casting to ISuperApp type (engn33r)](#15-informational---remove-unnecessary-casting-to-isuperapp-type-engn33r)
			- [Technical Details](#technical-details-26)
			- [Impact](#impact-32)
			- [Recommendation](#recommendation-32)
			- [Developer Response](#developer-response-26)
		- [16. Informational - Incorrect comments (engn33r)](#16-informational---incorrect-comments-engn33r)
			- [Technical Details](#technical-details-27)
			- [Impact](#impact-33)
			- [Recommendation](#recommendation-33)
			- [Developer Response](#developer-response-27)
		- [17. Informational - Variation in `isTrustedForwarder()` implementations (engn33r)](#17-informational---variation-in-istrustedforwarder-implementations-engn33r)
	...
	- [Fellows Informational Findings](#fellows-informational-findings)
		- [1. Informational - Implementation contracts not initialized (blockdev)](#1-informational---implementation-contracts-not-initialized-blockdev)
			- [Proof of concept](#proof-of-concept-3)
			- [Impact](#impact-35)
			- [Recommendation](#recommendation-35)
		- [2. Informational - Possible to register multiple apps with same `registrationKey` (blockdev)](#2-informational---possible-to-register-multiple-apps-with-same-registrationkey-blockdev)
			- [Proof of concept](#proof-of-concept-4)
			- [Impact](#impact-36)
			- [Recommendation](#recommendation-36)
		- [3. Informational - Valid context is not checked before modifying it (blockdev)](#3-informational---valid-context-is-not-checked-before-modifying-it-blockdev)
			- [Proof of concept](#proof-of-concept-5)
			- [Impact](#impact-37)
			- [Recommendation](#recommendation-37)
		- [4. Informational - Typo (blockdev)](#4-informational---typo-blockdev)
			- [Proof of concept](#proof-of-concept-6)
			- [Impact](#impact-38)
			- [Recommendation](#recommendation-38)
		- [5. Informational - Ambiguous endian of bitmap (verypoor)](#5-informational---ambiguous-endian-of-bitmap-verypoor)
			- [Impact](#impact-39)
			- [Recommendation](#recommendation-39)
		- [6. Informational - Add more comments and documentation (devtooligan)](#6-informational---add-more-comments-and-documentation-devtooligan)
