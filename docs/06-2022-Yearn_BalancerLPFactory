...
- [yAcademy Yearn BalancerLpFactory review](#yacademy-yearn-balancerlpfactory-review)
	...
	- [High Findings](#high-findings)
		- [1. High - Dependency on a single DEX for CRV price (blockdev, pashov)](#1-high---dependency-on-a-single-dex-for-crv-price-blockdev-pashov)
			- [Proof of concept](#proof-of-concept)
			- [Impact](#impact)
			- [Recommendation](#recommendation)
			- [Developer Response](#developer-response)
		- [2. High - Possible revert on creating a vault (blockdev, devtooligan, SaharAP)](#2-high---possible-revert-on-creating-a-vault-blockdev-devtooligan-saharap)
			- [Proof of concept](#proof-of-concept-1)
			- [Impact](#impact-1)
			- [Recommendation](#recommendation-1)
			- [Developer Response](#developer-response-1)
		- [3. High - Strategy migrations fail to claim reward/extraReward tokens (Benjamin Samuels)](#3-high---strategy-migrations-fail-to-claim-rewardextrareward-tokens-benjamin-samuels)
			- [Impact](#impact-2)
			- [Recommendation](#recommendation-2)
			- [Developer Response](#developer-response-2)
		- [4. `_loss` on `liquidatePosition()` is never accounted in strategy & vault, which can result in funds lost/stuck (pashov, Jib)](#4-_loss-on-liquidateposition-is-never-accounted-in-strategy--vault-which-can-result-in-funds-loststuck-pashov-jib)
			- [Proof of concept](#proof-of-concept-2)
			- [Impact](#impact-3)
			- [Recommendation](#recommendation-3)
			- [Developer Response](#developer-response-3)
		- [5. Dependence on Curve/Balancer governance (devtooligan, Jib)](#5-dependence-on-curvebalancer-governance-devtooligan-jib)
			- [Impact](#impact-4)
			- [Recommendation](#recommendation-4)
			- [Developer Response](#developer-response-4)
		- [6. Wrong parameter to cloneStrategyConvex function (datapunk)](#6-wrong-parameter-to-clonestrategyconvex-function-datapunk)
			- [Proof of concept](#proof-of-concept-3)
			- [Impact](#impact-5)
			- [Recommendation](#recommendation-5)
			- [Developer Response](#developer-response-5)
	- [Medium Findings](#medium-findings)
		- [1. Medium - Strategy migrations will cause inaccurate accounting on first harvest of new strategy (Benjamin Samuels)](#1-medium---strategy-migrations-will-cause-inaccurate-accounting-on-first-harvest-of-new-strategy-benjamin-samuels)
			- [Impact](#impact-6)
			- [Recommendation](#recommendation-6)
			- [Developer Response](#developer-response-6)
		- [2. Convex's extraRewards array is unbounded (pashov)](#2-convexs-extrarewards-array-is-unbounded-pashov)
			- [Proof of concept](#proof-of-concept-4)
			- [Impact](#impact-7)
			- [Recommendation](#recommendation-7)
			- [Developer Response](#developer-response-7)
	- [Low Findings](#low-findings)
		- [1. Low - _loss incorrectly assumed even if rewards can be sold to cover loss (Jib)](#1-low---_loss-incorrectly-assumed-even-if-rewards-can-be-sold-to-cover-loss-jib)
			- [Impact](#impact-8)
			- [Recommendation](#recommendation-8)
			- [Developer Response](#developer-response-8)
	- [Gas Savings Findings](#gas-savings-findings)
		- [1. Gas - Setting deposit limit twice (blockdev, devtooligan, datapunk)](#1-gas---setting-deposit-limit-twice-blockdev-devtooligan-datapunk)
			- [Proof of concept](#proof-of-concept-5)
			- [Impact](#impact-9)
			- [Recommendation](#recommendation-9)
			- [Dev Reply](#dev-reply)
		- [2. Gas - External call on each loop iteration (blockdev)](#2-gas---external-call-on-each-loop-iteration-blockdev)
			- [Proof of concept](#proof-of-concept-6)
			- [Developer Response](#developer-response-9)
			- [Impact](#impact-10)
			- [Recommendation](#recommendation-10)
		- [3. Gas - Use of SafeMath for safe arithmetic (blockdev)](#3-gas---use-of-safemath-for-safe-arithmetic-blockdev)
			- [Proof of concept](#proof-of-concept-7)
			- [Impact](#impact-11)
			- [Recommendation](#recommendation-11)
			- [Developer Response](#developer-response-10)
		- [4. Gas - Remove unused state variable (SaharAP)](#4-gas---remove-unused-state-variable-saharap)
			- [Proof of concept](#proof-of-concept-8)
			- [Impact](#impact-12)
			- [Recommendation](#recommendation-12)
			- [Developer Response](#developer-response-11)
		- [5. Gas - Use >0 for unsigned integers (SaharAP)](#5-gas---use-0-for-unsigned-integers-saharap)
			- [Proof of concept](#proof-of-concept-9)
			- [Impact](#impact-13)
			- [Recommendation](#recommendation-13)
			- [Developer Response](#developer-response-12)
		- [6. Storage variable `numVaults` in BalancerGlobal is not needed (pashov)](#6-storage-variable-numvaults-in-balancerglobal-is-not-needed-pashov)
			- [Proof of concept](#proof-of-concept-10)
			- [Recommendation](#recommendation-14)
			- [Developer Response](#developer-response-13)
		- [7. recalculation not needed (datapunk)](#7-recalculation-not-needed-datapunk)
			- [Proof of concept](#proof-of-concept-11)
			- [Recommendation](#recommendation-15)
		- [8. remove `tradesEnabled` (datapunk)](#8-remove-tradesenabled-datapunk)
			- [Proof of concept](#proof-of-concept-12)
			- [Recommendation](#recommendation-16)
			- [Developer Response](#developer-response-14)
		- [9. Iterating through `rewardsTokens` in `_setUpTradeFactory` and `_removeTradeFactoryPermissions` (verypoor)](#9-iterating-through-rewardstokens-in-_setuptradefactory-and-_removetradefactorypermissions-verypoor)
			- [Proof of concept](#proof-of-concept-13)
			- [Recommendation](#recommendation-17)
		- [10. Redundant external call when using `staticcall` (verypoor)](#10-redundant-external-call-when-using-staticcall-verypoor)
			- [Proof of concept](#proof-of-concept-14)
			- [Recommendation](#recommendation-18)
	- [Informational Findings](#informational-findings)
		- [1. Upgrade Pragma (devtooligan)](#1-upgrade-pragma-devtooligan)
			- [Impact](#impact-14)
			- [Recommendation](#recommendation-19)
			- [Developer Response](#developer-response-15)
		- [2. Informational - Missing events in BalancerGlobal & StrategyConvexFactoryClonable (Benjamin Samuels, pashov, datapunk)](#2-informational---missing-events-in-balancerglobal--strategyconvexfactoryclonable-benjamin-samuels-pashov-datapunk)
			- [Developer Response](#developer-response-16)
		- [3. ERC20.safeApprove is deprecated (pashov)](#3-erc20safeapprove-is-deprecated-pashov)
			- [Proof of concept](#proof-of-concept-15)
			- [Impact](#impact-15)
			- [Recommendation](#recommendation-20)
			- [Developer Response](#developer-response-17)
		- [4. Informational- incorrect comment (Jib)](#4-informational--incorrect-comment-jib)
			- [Proof of concept](#proof-of-concept-16)
			- [Impact](#impact-16)
			- [Recommendation](#recommendation-21)
			- [Developer Response](#developer-response-18)
		- [5. Informational- hardcoded addresses (verypoor)](#5-informational--hardcoded-addresses-verypoor)
			- [Proof of concept](#proof-of-concept-17)
			- [Impact](#impact-17)
			- [Recommendation](#recommendation-22)
			- [Developer Response](#developer-response-19)
	- [Out of Scope findings](#out-of-scope-findings)
		- [1. Medium - `VaultRegistry.latestVault()` functions can consume all gas (blockdev)](#1-medium---vaultregistrylatestvault-functions-can-consume-all-gas-blockdev)
