...
- [yAcademy OpenMEV review](#yacademy-openmev-review)
	...
	- [High Findings](#high-findings)
		- [1. High - The swap and stake mechanisms in OpenMevZapper leave funds in the contract (Jackson)](#1-high---the-swap-and-stake-mechanisms-in-openmevzapper-leave-funds-in-the-contract-jackson)
			- [Proof of concept](#proof-of-concept)
			- [Impact](#impact)
			- [Recommendation](#recommendation)
			- [Developer response (Sandy)](#developer-response-sandy)
		- [2. High - Using normal functions for fee-on-transfer tokens causes value loss (engn33r)](#2-high---using-normal-functions-for-fee-on-transfer-tokens-causes-value-loss-engn33r)
			- [Proof of concept](#proof-of-concept-1)
			- [Impact](#impact-1)
			- [Recommendation](#recommendation-1)
			- [Developer response (Sandy)](#developer-response-sandy-1)
		- [3. High - Backrun arb not designed for fee-on-transfer tokens (engn33r)](#3-high---backrun-arb-not-designed-for-fee-on-transfer-tokens-engn33r)
			- [Proof of concept](#proof-of-concept-2)
			- [Impact](#impact-2)
			- [Recommendation](#recommendation-2)
			- [Developer response (Sandy)](#developer-response-sandy-2)
	- [Medium Findings](#medium-findings)
		- [1. Medium - Failed flashloan arbitrage reverts the original swap (Jackson)](#1-medium---failed-flashloan-arbitrage-reverts-the-original-swap-jackson)
			- [Proof of concept](#proof-of-concept-3)
			- [Impact](#impact-3)
			- [Recommendation](#recommendation-3)
			- [Developer response (Sandy)](#developer-response-sandy-3)
	- [Low Findings](#low-findings)
		- [1. Low - Edge case suboptimal arb profit (engn33r)](#1-low---edge-case-suboptimal-arb-profit-engn33r)
			- [Proof of concept](#proof-of-concept-4)
			- [Impact](#impact-4)
			- [Recommendation](#recommendation-4)
			- [Developer response (Sandy)](#developer-response-sandy-4)
		- [2. Low - One failed arb can revert otherwise profitable arb (engn33r)](#2-low---one-failed-arb-can-revert-otherwise-profitable-arb-engn33r)
			- [Proof of concept](#proof-of-concept-5)
			- [Impact](#impact-5)
			- [Recommendation](#recommendation-5)
			- [Developer response (Sandy)](#developer-response-sandy-5)
		- [3. Low - Max approval granted to spender (Jackson)](#3-low---max-approval-granted-to-spender-jackson)
			- [Proof of concept](#proof-of-concept-6)
			- [Impact](#impact-6)
			- [Recommendation](#recommendation-6)
			- [Developer response (Sandy)](#developer-response-sandy-6)
		- [4. Low - No check For Aave flashloan balance (Jackson)](#4-low---no-check-for-aave-flashloan-balance-jackson)
			- [Proof of concept](#proof-of-concept-7)
			- [Impact](#impact-7)
			- [Recommendation](#recommendation-7)
			- [Developer response (Sandy)](#developer-response-sandy-7)
	- [Gas Savings Findings](#gas-savings-findings)
		- [1. Gas - Use `_isNonZero()` for gas savings (engn33r)](#1-gas---use-_isnonzero-for-gas-savings-engn33r)
			- [Proof of Concept](#proof-of-concept-8)
			- [Impact](#impact-8)
			- [Recommendation](#recommendation-8)
			- [Developer response (Sandy)](#developer-response-sandy-8)
		- [2. Gas - Use `_inc()` instead of `++` and `_dec()` instead of `--` (engn33r)](#2-gas---use-_inc-instead-of--and-_dec-instead-of----engn33r)
			- [Proof of concept](#proof-of-concept-9)
			- [Impact](#impact-9)
			- [Recommendation](#recommendation-9)
			- [Developer response (Sandy)](#developer-response-sandy-9)
		- [3. Gas - Bitshifting is cheaper than multiplication or division (engn33r)](#3-gas---bitshifting-is-cheaper-than-multiplication-or-division-engn33r)
			- [Proof of concept](#proof-of-concept-10)
			- [Impact](#impact-10)
			- [Recommendation](#recommendation-10)
			- [Developer response (Sandy)](#developer-response-sandy-10)
		- [4. Gas - Unnecessary zero initialization (engn33r)](#4-gas---unnecessary-zero-initialization-engn33r)
			- [Proof of Concept](#proof-of-concept-11)
			- [Impact](#impact-11)
			- [Recommendation](#recommendation-11)
			- [Developer response (Sandy)](#developer-response-sandy-11)
		- [5. Gas - Payable functions can save gas (engn33r)](#5-gas---payable-functions-can-save-gas-engn33r)
			- [Proof of concept](#proof-of-concept-12)
			- [Impact](#impact-12)
			- [Recommendation](#recommendation-12)
			- [Developer response (Sandy)](#developer-response-sandy-12)
		- [6. Gas - Avoid && logic in require statements (engn33r)](#6-gas---avoid--logic-in-require-statements-engn33r)
			- [Proof of concept](#proof-of-concept-13)
			- [Impact](#impact-13)
			- [Recommendation](#recommendation-13)
			- [Developer response (Sandy)](#developer-response-sandy-13)
		- [7. Gas - Declare constant internal when possible (engn33r)](#7-gas---declare-constant-internal-when-possible-engn33r)
			- [Proof of concept](#proof-of-concept-14)
			- [Impact](#impact-14)
			- [Recommendation](#recommendation-14)
			- [Developer response (Sandy)](#developer-response-sandy-14)
		- [8. Gas - Replace require with errors in OpenMevRouter (Jackson)](#8-gas---replace-require-with-errors-in-openmevrouter-jackson)
			- [Proof of concept](#proof-of-concept-15)
			- [Impact](#impact-15)
			- [Recommendation](#recommendation-15)
			- [Developer response (Sandy)](#developer-response-sandy-15)
		- [9. Gas - Remove unused code (Jackson)](#9-gas---remove-unused-code-jackson)
			- [Proof of concept](#proof-of-concept-16)
			- [Impact](#impact-16)
			- [Recommendation](#recommendation-16)
			- [Developer response (Sandy)](#developer-response-sandy-16)
		- [10. Gas - Use simple comparison (engn33r)](#10-gas---use-simple-comparison-engn33r)
			- [Proof of concept](#proof-of-concept-17)
			- [Impact](#impact-17)
			- [Recommendation](#recommendation-17)
			- [Developer response (Sandy)](#developer-response-sandy-17)
		- [11. Gas - Combine reserve value checks (engn33r)](#11-gas---combine-reserve-value-checks-engn33r)
			- [Proof of concept](#proof-of-concept-18)
			- [Impact](#impact-18)
			- [Recommendation](#recommendation-18)
			- [Developer response (Sandy)](#developer-response-sandy-18)
		- [12. Gas - Use msg global vars directly (engn33r)](#12-gas---use-msg-global-vars-directly-engn33r)
			- [Proof of concept](#proof-of-concept-19)
			- [Impact](#impact-19)
			- [Recommendation](#recommendation-19)
			- [Developer response (Sandy)](#developer-response-sandy-19)
		- [13. Gas - Remove duplicate internal function call (engn33r)](#13-gas---remove-duplicate-internal-function-call-engn33r)
			- [Proof of concept](#proof-of-concept-20)
			- [Impact](#impact-20)
			- [Recommendation](#recommendation-20)
			- [Developer response (Sandy)](#developer-response-sandy-20)
		- [14. Gas - deadline special case not aligned with permit (engn33r)](#14-gas---deadline-special-case-not-aligned-with-permit-engn33r)
			- [Proof of concept](#proof-of-concept-21)
			- [Impact](#impact-21)
			- [Recommendation](#recommendation-21)
			- [Developer response (Sandy)](#developer-response-sandy-21)
		- [15. Gas - Replace `pair.swap()` with `_asmSwap()` (engn33r)](#15-gas---replace-pairswap-with-_asmswap-engn33r)
			- [Proof of concept](#proof-of-concept-22)
			- [Impact](#impact-22)
			- [Recommendation](#recommendation-22)
			- [Developer response (Sandy)](#developer-response-sandy-22)
		- [16. Gas - Remove a sortTokens call (engn33r)](#16-gas---remove-a-sorttokens-call-engn33r)
			- [Proof of concept](#proof-of-concept-23)
			- [Impact](#impact-23)
			- [Recommendation](#recommendation-23)
			- [Developer response (Sandy)](#developer-response-sandy-23)
		- [17. Gas - Missing curly brace (engn33r)](#17-gas---missing-curly-brace-engn33r)
			- [Proof of concept](#proof-of-concept-24)
			- [Impact](#impact-24)
			- [Recommendation](#recommendation-24)
			- [Developer response (Sandy)](#developer-response-sandy-24)
		- [18. Gas - Reduce number of swaps (engn33r)](#18-gas---reduce-number-of-swaps-engn33r)
			- [Proof of concept](#proof-of-concept-25)
			- [Impact](#impact-25)
			- [Recommendation](#recommendation-25)
			- [Developer response (Sandy)](#developer-response-sandy-25)
		- [19. Gas - Revert if zero flashloan profit (engn33r)](#19-gas---revert-if-zero-flashloan-profit-engn33r)
			- [Proof of concept](#proof-of-concept-26)
			- [Impact](#impact-26)
			- [Recommendation](#recommendation-26)
			- [Developer response (Sandy)](#developer-response-sandy-26)
	- [Informational Findings](#informational-findings)
		- [1. Informational - OpenMevRouter should inherit from IFlashBorrower and IOpenMevRouter (Jackson)](#1-informational---openmevrouter-should-inherit-from-iflashborrower-and-iopenmevrouter-jackson)
			- [Impact](#impact-27)
			- [Developer response (Sandy)](#developer-response-sandy-27)
		- [2. Informational - The ETHERSCAN_API key is present in plaintext (Jackson)](#2-informational---the-etherscan_api-key-is-present-in-plaintext-jackson)
			- [Impact](#impact-28)
			- [Developer response (Sandy)](#developer-response-sandy-28)
		- [3. Informational - SafeTransferLib does not match Solmate's main branch (Jackson)](#3-informational---safetransferlib-does-not-match-solmates-main-branch-jackson)
			- [Impact](#impact-29)
			- [Developer response (Sandy)](#developer-response-sandy-29)
		- [4. Informational - Incorrect comment (engn33r, Jackson)](#4-informational---incorrect-comment-engn33r-jackson)
			- [Proof of concept](#proof-of-concept-27)
			- [Impact](#impact-30)
			- [Recommendation](#recommendation-27)
			- [Developer response (Sandy)](#developer-response-sandy-30)
		- [5. Informational - Replace magic numbers with constants (engn33r)](#5-informational---replace-magic-numbers-with-constants-engn33r)
			- [Proof of concept](#proof-of-concept-28)
			- [Impact](#impact-31)
			- [Recommendation](#recommendation-28)
			- [Developer response (Sandy)](#developer-response-sandy-31)
		- [6. Informational - Typos (engn33r)](#6-informational---typos-engn33r)
			- [Proof of concept](#proof-of-concept-29)
			- [Impact](#impact-32)
			- [Recommendation](#recommendation-29)
			- [Developer response (Sandy)](#developer-response-sandy-32)
		- [7. Informational - Hard coded Aave token list (engn33r)](#7-informational---hard-coded-aave-token-list-engn33r)
			- [Proof of concept](#proof-of-concept-30)
			- [Impact](#impact-33)
			- [Recommendation](#recommendation-30)
			- [Developer response (Sandy)](#developer-response-sandy-33)
		- [8. Informational - Inconsistency in WETH transfers (engn33r)](#8-informational---inconsistency-in-weth-transfers-engn33r)
			- [Proof of concept](#proof-of-concept-31)
			- [Impact](#impact-34)
			- [Recommendation](#recommendation-31)
			- [Developer response (Sandy)](#developer-response-sandy-34)
		- [9. Informational - safeApprove vulnerable to double withdraw (engn33r)](#9-informational---safeapprove-vulnerable-to-double-withdraw-engn33r)
			- [Proof of concept](#proof-of-concept-32)
			- [Impact](#impact-35)
			- [Recommendation](#recommendation-32)
			- [Developer response (Sandy)](#developer-response-sandy-35)
		- [10. Informational - Same frontrunning weaknesses as Uniswap/SushiSwap (engn33r)](#10-informational---same-frontrunning-weaknesses-as-uniswapsushiswap-engn33r)
			- [Proof of concept](#proof-of-concept-33)
			- [Impact](#impact-36)
			- [Recommendation](#recommendation-33)
			- [Developer response (Sandy)](#developer-response-sandy-36)
		- [11. Informational - Kashi flashloanable tokens assumed same as aave (engn33r)](#11-informational---kashi-flashloanable-tokens-assumed-same-as-aave-engn33r)
			- [Proof of concept](#proof-of-concept-34)
			- [Impact](#impact-37)
			- [Recommendation](#recommendation-34)
			- [Developer response (Sandy)](#developer-response-sandy-37)
		- [12. Informational -  (engn33r)](#12-informational----engn33r)
			- [Proof of concept](#proof-of-concept-35)
			- [Impact](#impact-38)
			- [Recommendation](#recommendation-35)
			- [Developer response (Sandy)](#developer-response-sandy-38)
