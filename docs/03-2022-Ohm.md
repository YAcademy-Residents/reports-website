...
- [yAcademy Ohm review](#yacademy-ohm-review)
	...
	- [High Findings](#high-findings)
		- [1. staking.unstake() should set rebasing bool to true (engn33r)](#1-stakingunstake-should-set-rebasing-bool-to-true-engn33r)
			- [Proof of concept](#proof-of-concept)
			- [Impact](#impact)
			- [Recommendation](#recommendation)
			- [Remediation Status](#remediation-status)
		- [2. Sandwich attack risk in YieldStreamer.sol (engn33r)](#2-sandwich-attack-risk-in-yieldstreamersol-engn33r)
			- [Proof of concept](#proof-of-concept-1)
			- [Impact](#impact-1)
			- [Recommendation](#recommendation-1)
			- [Remediation Status](#remediation-status-1)
	- [Medium Findings](#medium-findings)
		- [1. Denial of service in upkeep "for" loop in YieldStreamer.sol (sjkelleyjr)](#1-denial-of-service-in-upkeep-for-loop-in-yieldstreamersol-sjkelleyjr)
			- [Proof of concept](#proof-of-concept-2)
			- [Impact](#impact-2)
			- [Recommendation](#recommendation-2)
			- [Remediation Status](#remediation-status-2)
	- [Low Findings](#low-findings)
		- [1. `donatedTo` and `depositsTo` only return the first of N possible donation or deposit mappings (sjkelleyjr)](#1-donatedto-and-depositsto-only-return-the-first-of-n-possible-donation-or-deposit-mappings-sjkelleyjr)
			- [Proof of concept](#proof-of-concept-3)
			- [Impact](#impact-3)
			- [Recommendation](#recommendation-3)
			- [Remediation Status](#remediation-status-3)
		- [2. `_redeemAll()` does not delete recipientLookup (sjkelleyjr)](#2-_redeemall-does-not-delete-recipientlookup-sjkelleyjr)
			- [Proof of concept](#proof-of-concept-4)
			- [Impact](#impact-4)
			- [Recommendation](#recommendation-4)
			- [Remediation Status](#remediation-status-4)
	- [Gas Savings Findings](#gas-savings-findings)
		- [1. Declare function external for gas savings (sjkelleyjr)](#1-declare-function-external-for-gas-savings-sjkelleyjr)
			- [Proof of concept](#proof-of-concept-5)
			- [Impact](#impact-5)
			- [Proof of concept](#proof-of-concept-6)
			- [Remediation Status](#remediation-status-5)
		- [2. Use == for gas savings (sjkelleyjr)](#2-use--for-gas-savings-sjkelleyjr)
			- [Proof of concept](#proof-of-concept-7)
			- [Impact](#impact-6)
			- [Recommendation](#recommendation-5)
			- [Remediation Status](#remediation-status-6)
		- [3. Simplify math for gas savings (engn33r)](#3-simplify-math-for-gas-savings-engn33r)
			- [Proof of concept](#proof-of-concept-8)
			- [Impact](#impact-7)
			- [Recommendation](#recommendation-6)
			- [Remediation Status](#remediation-status-7)
		- [4. Use msg.sender for gas savings (engn33r)](#4-use-msgsender-for-gas-savings-engn33r)
			- [Proof of concept](#proof-of-concept-9)
			- [Impact](#impact-8)
			- [Recommendation](#recommendation-7)
			- [Remediation Status](#remediation-status-8)
		- [5. Remove functions to save gas on deployment (engn33r)](#5-remove-functions-to-save-gas-on-deployment-engn33r)
			- [Proof of concept](#proof-of-concept-10)
			- [Impact](#impact-9)
			- [Recommendation](#recommendation-8)
			- [Remediation Status](#remediation-status-9)
		- [6. Gas savings using unchecked (engn33r)](#6-gas-savings-using-unchecked-engn33r)
			- [Proof of concept](#proof-of-concept-11)
			- [Impact](#impact-10)
			- [Recommendation](#recommendation-9)
			- [Remediation Status](#remediation-status-10)
		- [7. Gas savings with memory variable (engn33r)](#7-gas-savings-with-memory-variable-engn33r)
			- [Proof of concept](#proof-of-concept-12)
			- [Impact](#impact-11)
			- [Recommendation](#recommendation-10)
			- [Remediation Status](#remediation-status-11)
		- [8. redeemAll repeatedly computes index - 1 (NibblerExpress)](#8-redeemall-repeatedly-computes-index---1-nibblerexpress)
			- [Proof of Concept](#proof-of-concept-13)
			- [Impact](#impact-12)
			- [Recommendation](#recommendation-11)
			- [Remediation Status](#remediation-status-12)
	- [Informational Findings](#informational-findings)
		- [1. Miscellaneous Improvement Ideas (engn33r)](#1-miscellaneous-improvement-ideas-engn33r)
			- [Proof of concept](#proof-of-concept-14)
			- [Impact](#impact-13)
			- [Recommendation](#recommendation-12)
			- [Remediation Status](#remediation-status-13)
		- [2. updateUserMinDaiThreshold assumes Dai is used as the streamToken (sjkelleyjr)](#2-updateusermindaithreshold-assumes-dai-is-used-as-the-streamtoken-sjkelleyjr)
			- [Proof of concept](#proof-of-concept-15)
			- [Impact](#impact-14)
			- [Recommendation](#recommendation-13)
			- [Remediation Status](#remediation-status-14)
		- [3. Missing calls in scripts/deployAll.js (engn33r)](#3-missing-calls-in-scriptsdeployalljs-engn33r)
			- [Proof of concept](#proof-of-concept-16)
			- [Impact](#impact-15)
			- [Recommendation](#recommendation-14)
			- [Remediation Status](#remediation-status-15)
	- [Final remarks](#final-remarks)
		- [sjkelleyjr](#sjkelleyjr)
		- [engn33r](#engn33r)
