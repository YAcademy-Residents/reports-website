...
- [yAcademy Singularity v2 review](#yacademy-singularity-v2-review)
	...
	- [Residents High findings](#residents-high-findings)
		- [1. High - Possible locking of pool fee funds (engn33r)](#1-high---possible-locking-of-pool-fee-funds-engn33r)
			- [Technical Details](#technical-details)
			- [Impact](#impact)
			- [Recommendation](#recommendation)
			- [Developer response](#developer-response)
		- [2. High - Pools mechanics don't incentivize end goal (engn33r)](#2-high---pools-mechanics-dont-incentivize-end-goal-engn33r)
			- [Technical Details](#technical-details-1)
			- [Impact](#impact-1)
			- [Recommendation](#recommendation-1)
			- [Developer response](#developer-response-1)
		- [3. High - Flashloan/Whale slippage manipulation (engn33r, NibblerExpress)](#3-high---flashloanwhale-slippage-manipulation-engn33r-nibblerexpress)
			- [Technical Details](#technical-details-2)
			- [Impact](#impact-2)
			- [Recommendation](#recommendation-2)
			- [Developer response](#developer-response-2)
		- [4. High - Single depositor in pool can steal funds from other pools (NibblerExpress)](#4-high---single-depositor-in-pool-can-steal-funds-from-other-pools-nibblerexpress)
			- [Technical Details](#technical-details-3)
			- [Impact](#impact-3)
			- [Recommendation](#recommendation-3)
			- [Developer response](#developer-response-3)
	- [Fellows High findings](#fellows-high-findings)
		- [1. High - allPrices gas grieving causes complete loss of on-chain oracle (devtooligan)](#1-high---allprices-gas-grieving-causes-complete-loss-of-on-chain-oracle-devtooligan)
			- [Proof of concept](#proof-of-concept)
			- [Impact](#impact-4)
			- [Recommendation](#recommendation-4)
				- [Developer response](#developer-response-4)
		- [2. High - Pool drain via Oracle Update Sandwich Attack (Benjamin Samuels)](#2-high---pool-drain-via-oracle-update-sandwich-attack-benjamin-samuels)
			- [Proof of concept](#proof-of-concept-1)
			- [Impact](#impact-5)
			- [Recommendation](#recommendation-5)
			- [Developer response](#developer-response-5)
		- [3. High - Incorrect tolerance for price reported by Chainlink Oracle (blockdev)](#3-high---incorrect-tolerance-for-price-reported-by-chainlink-oracle-blockdev)
			- [Proof of concept](#proof-of-concept-2)
			- [Impact](#impact-6)
			- [Recommendation](#recommendation-6)
			- [Developer response](#developer-response-6)
		- [4. High - Frozen protocol fee when too many pools are deployed (blockdev)](#4-high---frozen-protocol-fee-when-too-many-pools-are-deployed-blockdev)
			- [Proof of concept](#proof-of-concept-3)
			- [Impact](#impact-7)
			- [Recommendation](#recommendation-7)
			- [Developer response](#developer-response-7)
		- [5. High - Planned functionality incentivizes low pool liquidity (uk)](#5-high---planned-functionality-incentivizes-low-pool-liquidity-uk)
			- [Proof of concept](#proof-of-concept-4)
			- [Impact](#impact-8)
			- [Recommendation](#recommendation-8)
			- [Developer response](#developer-response-8)
	- [Guest auditors High findings](#guest-auditors-high-findings)
		- [1. High - Deposit fees even below 100% CR & withdrawal fees above 100%](#1-high---deposit-fees-even-below-100-cr--withdrawal-fees-above-100)
			- [Impact](#impact-9)
			- [Recommended Mitigation Steps](#recommended-mitigation-steps)
			- [Developer response](#developer-response-9)
		- [2. High - `_getG` is not continuous](#2-high---_getg-is-not-continuous)
			- [Impact](#impact-10)
			- [Recommended Mitigation Steps](#recommended-mitigation-steps-1)
			- [Developer response](#developer-response-10)
		- [3. High - `maxPriceTolerance` does not work correctly](#3-high---maxpricetolerance-does-not-work-correctly)
			- [Impact](#impact-11)
			- [Recommended Mitigation Steps](#recommended-mitigation-steps-2)
			- [Developer response](#developer-response-11)
		- [4. High - Price updates can be sandwiched](#4-high---price-updates-can-be-sandwiched)
			- [Impact](#impact-12)
	...
	- [Residents Medium Findings](#residents-medium-findings)
		- [1. Medium - Chainlink oracle may return stale data (engn33r)](#1-medium---chainlink-oracle-may-return-stale-data-engn33r)
			- [Technical Details](#technical-details-4)
			- [Impact](#impact-13)
			- [Recommendation](#recommendation-9)
		- [2. Medium - Fee-free `deposit()` and `withdraw()` can be gamed (engn33r)](#2-medium---fee-free-deposit-and-withdraw-can-be-gamed-engn33r)
			- [Technical Details](#technical-details-5)
			- [Impact](#impact-14)
			- [Recommendation](#recommendation-10)
		- [3. Medium - Mechanics increase bank run risk (engn33r)](#3-medium---mechanics-increase-bank-run-risk-engn33r)
			- [Technical Details](#technical-details-6)
			- [Impact](#impact-15)
			- [Recommendation](#recommendation-11)
			- [Developer response](#developer-response-13)
		- [4. Medium - Oracle price lag enables 1% arbitrage opportunities (engn33r)](#4-medium---oracle-price-lag-enables-1-arbitrage-opportunities-engn33r)
			- [Technical Details](#technical-details-7)
			- [Impact](#impact-16)
			- [Recommendation](#recommendation-12)
			- [Developer response](#developer-response-14)
	- [Fellows Medium findings](#fellows-medium-findings)
		- [1. Medium - Slippage calculations are not path independent for large trades (blockdev, Benjamin Samuels)](#1-medium---slippage-calculations-are-not-path-independent-for-large-trades-blockdev-benjamin-samuels)
			- [Proof of concept](#proof-of-concept-6)
			- [Impact](#impact-17)
			- [Recommendation](#recommendation-13)
		- [2. Medium - Reentrancy in `SingularityPool.collectFees()` (Benjamin Samuels)](#2-medium---reentrancy-in-singularitypoolcollectfees-benjamin-samuels)
			- [Proof of concept](#proof-of-concept-7)
			- [Impact](#impact-18)
			- [Recommendation](#recommendation-14)
			- [Developer response](#developer-response-15)
	- [Guest auditors Medium findings](#guest-auditors-medium-findings)
		- [1. Medium - It can be profitable to split up orders](#1-medium---it-can-be-profitable-to-split-up-orders)
			- [Impact](#impact-19)
			- [Proof of concept](#proof-of-concept-8)
			- [Recommended Mitigation Steps](#recommended-mitigation-steps-4)
		- [2. Medium - `_getG` exponentiation can overflow for large CR values](#2-medium---_getg-exponentiation-can-overflow-for-large-cr-values)
			- [Impact](#impact-20)
			- [Proof of concept](#proof-of-concept-9)
			- [Recommended Mitigation Steps](#recommended-mitigation-steps-5)
	- [Low Findings](#low-findings)
	- [Residents Low Findings](#residents-low-findings)
		- [1. Low - Todo comment indicates necessary change (engn33r)](#1-low---todo-comment-indicates-necessary-change-engn33r)
			- [Technical Details](#technical-details-8)
			- [Impact](#impact-21)
			- [Recommendation](#recommendation-15)
		- [2. Low - Denial of service edge case if `onlyUseChainlink` is false (engn33r)](#2-low---denial-of-service-edge-case-if-onlyusechainlink-is-false-engn33r)
			- [Technical Details](#technical-details-9)
			- [Impact](#impact-22)
			- [Recommendation](#recommendation-16)
		- [3. Low - No pool existence check (engn33r)](#3-low---no-pool-existence-check-engn33r)
			- [Technical Details](#technical-details-10)
			- [Impact](#impact-23)
			- [Recommendation](#recommendation-17)
			- [Developer response](#developer-response-16)
		- [4. Low - Missing zero address check (engn33r)](#4-low---missing-zero-address-check-engn33r)
			- [Technical Details](#technical-details-11)
			- [Impact](#impact-24)
			- [Recommendation](#recommendation-18)
			- [Developer response](#developer-response-17)
		- [5. Low - g function discontinuity at 0.3 (engn33r)](#5-low---g-function-discontinuity-at-03-engn33r)
			- [Technical Details](#technical-details-12)
			- [Impact](#impact-25)
			- [Recommendation](#recommendation-19)
			- [Developer response](#developer-response-18)
	- [Fellows Low findings](#fellows-low-findings)
		- [1. Low - Missing two-step transfer ownership pattern (blockdev, SaharAP)](#1-low---missing-two-step-transfer-ownership-pattern-blockdev-saharap)
			- [Proof of concept](#proof-of-concept-10)
			- [Impact](#impact-26)
			- [Recommendation](#recommendation-20)
		- [2. Low - Division before multiplication (SaharAP)](#2-low---division-before-multiplication-saharap)
			- [Proof of concept](#proof-of-concept-11)
			- [Impact](#impact-27)
			- [Recommendation](#recommendation-21)
			- [Developer response](#developer-response-19)
	- [Guest auditors Low Findings](#guest-auditors-low-findings)
		- [1. Low - Deposit cap is inaccurate](#1-low---deposit-cap-is-inaccurate)
			- [Impact](#impact-28)
	...
	- [Residents Gas Savings Findings](#residents-gas-savings-findings)
		- [1. Gas - Use unchecked in SingularityPool.sol (engn33r)](#1-gas---use-unchecked-in-singularitypoolsol-engn33r)
			- [Technical Details](#technical-details-13)
			- [Impact](#impact-29)
			- [Recommendation](#recommendation-22)
			- [Developer response](#developer-response-21)
		- [2. Gas - Replace modifiers with internal functions (engn33r)](#2-gas---replace-modifiers-with-internal-functions-engn33r)
			- [Technical Details](#technical-details-14)
			- [Impact](#impact-30)
			- [Recommendation](#recommendation-23)
			- [Developer response](#developer-response-22)
		- [3. Gas - Payable functions can save gas (engn33r)](#3-gas---payable-functions-can-save-gas-engn33r)
			- [Technical Details](#technical-details-15)
			- [Impact](#impact-31)
			- [Recommendation](#recommendation-24)
			- [Developer response](#developer-response-23)
		- [4. Gas - Use short require strings (engn33r)](#4-gas---use-short-require-strings-engn33r)
			- [Technical Details](#technical-details-16)
			- [Impact](#impact-32)
			- [Recommendation](#recommendation-25)
			- [Developer response](#developer-response-24)
		- [5. Gas - Use Solidity errors in 0.8.4+ (engn33r)](#5-gas---use-solidity-errors-in-084-engn33r)
			- [Technical Details](#technical-details-17)
			- [Impact](#impact-33)
			- [Recommendation](#recommendation-26)
			- [Developer response](#developer-response-25)
		- [6. Gas - Using simple comparison (engn33r)](#6-gas---using-simple-comparison-engn33r)
			- [Technical Details](#technical-details-18)
			- [Impact](#impact-34)
			- [Recommendation](#recommendation-27)
			- [Developer response](#developer-response-26)
		- [7. Gas - Using Yul `iszero()` (engn33r)](#7-gas---using-yul-iszero-engn33r)
			- [Technical Details](#technical-details-19)
			- [Impact](#impact-35)
			- [Recommendation](#recommendation-28)
			- [Developer response](#developer-response-27)
		- [8. Gas - Replace bool with uint256 (engn33r)](#8-gas---replace-bool-with-uint256-engn33r)
			- [Technical Details](#technical-details-20)
			- [Impact](#impact-36)
			- [Recommendation](#recommendation-29)
			- [Developer response](#developer-response-28)
		- [9. Gas - Declare immutable variables internal when possible (engn33r)](#9-gas---declare-immutable-variables-internal-when-possible-engn33r)
			- [Technical Details](#technical-details-21)
			- [Impact](#impact-37)
			- [Recommendation](#recommendation-30)
			- [Developer response](#developer-response-29)
		- [10. Gas - Redundant function (engn33r)](#10-gas---redundant-function-engn33r)
			- [Technical Details](#technical-details-22)
			- [Impact](#impact-38)
			- [Recommendation](#recommendation-31)
			- [Developer response](#developer-response-30)
		- [11. Gas - Remove nonReentrant modifiers (engn33r)](#11-gas---remove-nonreentrant-modifiers-engn33r)
			- [Technical Details](#technical-details-23)
			- [Impact](#impact-39)
			- [Recommendation](#recommendation-32)
			- [Developer response](#developer-response-31)
		- [12. Gas - Remove `feeA > feeB` test in `getDepositFee()` (engn33r)](#12-gas---remove-feea--feeb-test-in-getdepositfee-engn33r)
			- [Technical Details](#technical-details-24)
			- [Impact](#impact-40)
			- [Recommendation](#recommendation-33)
			- [Developer response](#developer-response-32)
	- [Fellows Gas Savings Findings](#fellows-gas-savings-findings)
		- [1. Gas - Collateral ratio calculations have redundant SLOADs (Benjamin Samuels)](#1-gas---collateral-ratio-calculations-have-redundant-sloads-benjamin-samuels)
			- [Proof of concept](#proof-of-concept-12)
			- [Impact](#impact-41)
			- [Recommendation](#recommendation-34)
			- [Developer response](#developer-response-33)
		- [2. Gas - Replace ProtocolFees state var with Slippage (devtooligan)](#2-gas---replace-protocolfees-state-var-with-slippage-devtooligan)
			- [Impact](#impact-42)
			- [Recommendation](#recommendation-35)
		- [3. Gas - Tight variable packing (devtooligan)](#3-gas---tight-variable-packing-devtooligan)
			- [Proof of concept](#proof-of-concept-13)
			- [Impact](#impact-43)
			- [Recommendation](#recommendation-36)
			- [Developer response](#developer-response-34)
		- [4. Gas - Use `unchecked` when there is no risk of overflow or underflow (blockdev)](#4-gas---use-unchecked-when-there-is-no-risk-of-overflow-or-underflow-blockdev)
			- [Proof of concept](#proof-of-concept-14)
			- [Impact](#impact-44)
			- [Recommendation](#recommendation-37)
			- [Developer response](#developer-response-35)
		- [5. Gas - Do not load calldata length in memory for loops (blockdev)](#5-gas---do-not-load-calldata-length-in-memory-for-loops-blockdev)
			- [Proof of concept](#proof-of-concept-15)
			- [Impact](#impact-45)
			- [Recommendation](#recommendation-38)
			- [Developer response](#developer-response-36)
		- [6. Gas - Unnecessary named return variable assignment (blockdev)](#6-gas---unnecessary-named-return-variable-assignment-blockdev)
			- [Proof of concept](#proof-of-concept-16)
			- [Impact](#impact-46)
			- [Recommendation](#recommendation-39)
			- [Developer response](#developer-response-37)
		- [7. Gas - Combine accounting updates in `swapIn` and `swapOut` (uk)](#7-gas---combine-accounting-updates-in-swapin-and-swapout-uk)
			- [Proof of concept](#proof-of-concept-17)
			- [Impact](#impact-47)
			- [Recommendation](#recommendation-40)
			- [Developer response](#developer-response-38)
		- [8. Gas - Routers can give infinite token approval to pools (blockdev)](#8-gas---routers-can-give-infinite-token-approval-to-pools-blockdev)
			- [Proof of concept](#proof-of-concept-18)
			- [Impact](#impact-48)
			- [Recommendation](#recommendation-41)
			- [Developer response](#developer-response-39)
		- [9. Gas - Immutable state variable which is defined as a public variable (saharAP)](#9-gas---immutable-state-variable-which-is-defined-as-a-public-variable-saharap)
			- [Proof of concept](#proof-of-concept-19)
			- [Impact](#impact-49)
			- [Recommendation](#recommendation-42)
	- [Informational Findings](#informational-findings)
	- [Residents Informational Findings](#residents-informational-findings)
		- [1. Informational - Difference from Uniswap's `safeTransferFrom()` logic (engn33r)](#1-informational---difference-from-uniswaps-safetransferfrom-logic-engn33r)
			- [Technical Details](#technical-details-25)
			- [Impact](#impact-50)
			- [Recommendation](#recommendation-43)
			- [Developer response](#developer-response-40)
		- [2. Informational - Centralization risk with admin role (engn33r)](#2-informational---centralization-risk-with-admin-role-engn33r)
			- [Technical Details](#technical-details-26)
			- [Impact](#impact-51)
			- [Recommendation](#recommendation-44)
			- [Developer response](#developer-response-41)
		- [3. Informational - `baseFee` value not limited (engn33r)](#3-informational---basefee-value-not-limited-engn33r)
			- [Technical Details](#technical-details-27)
			- [Impact](#impact-52)
			- [Recommendation](#recommendation-45)
			- [Developer response](#developer-response-42)
		- [4. Informational - No way to remove pools (engn33r)](#4-informational---no-way-to-remove-pools-engn33r)
			- [Technical Details](#technical-details-28)
			- [Impact](#impact-53)
			- [Recommendation](#recommendation-46)
			- [Developer response](#developer-response-43)
		- [5. Informational - Fee-on-transfer tokens not supported (engn33r)](#5-informational---fee-on-transfer-tokens-not-supported-engn33r)
			- [Technical Details](#technical-details-29)
			- [Impact](#impact-54)
			- [Recommendation](#recommendation-47)
			- [Developer response](#developer-response-44)
		- [6. Informational - Documentation inconsistencies (engn33r)](#6-informational---documentation-inconsistencies-engn33r)
			- [Technical Details](#technical-details-30)
			- [Impact](#impact-55)
			- [Recommendation](#recommendation-48)
			- [Developer response](#developer-response-45)
		- [7. Informational - Decimals value borrowed from underlying ERC20 (engn33r)](#7-informational---decimals-value-borrowed-from-underlying-erc20-engn33r)
			- [Technical Details](#technical-details-31)
			- [Impact](#impact-56)
			- [Recommendation](#recommendation-49)
			- [Developer response](#developer-response-46)
		- [8. Informational - Typo (engn33r)](#8-informational---typo-engn33r)
			- [Technical Details](#technical-details-32)
			- [Impact](#impact-57)
			- [Recommendation](#recommendation-50)
			- [Developer response](#developer-response-47)
		- [9. Informational - nonReentrant modifier is specific to each pool (engn33r)](#9-informational---nonreentrant-modifier-is-specific-to-each-pool-engn33r)
			- [Technical Details](#technical-details-33)
			- [Impact](#impact-58)
			- [Recommendation](#recommendation-51)
			- [Developer response](#developer-response-48)
		- [10. Informational - Pool may not be able to reach `depositCap` (engn33r)](#10-informational---pool-may-not-be-able-to-reach-depositcap-engn33r)
			- [Technical Details](#technical-details-34)
			- [Impact](#impact-59)
			- [Recommendation](#recommendation-52)
			- [Developer response](#developer-response-49)
	- [Fellows Informational Findings](#fellows-informational-findings)
		- [1. Informational - Incorrect balance accounting for fee-on-transfer and rebasing tokens (blockdev)](#1-informational---incorrect-balance-accounting-for-fee-on-transfer-and-rebasing-tokens-blockdev)
			- [Proof of concept](#proof-of-concept-20)
		- [2. Informational - Reduce footgun risk of deposit() and withdraw() (devtooligan)](#2-informational---reduce-footgun-risk-of-deposit-and-withdraw-devtooligan)
	- [Guest auditors Informational Findings](#guest-auditors-informational-findings)
		- [1. Informational - Code does not match docs](#1-informational---code-does-not-match-docs)
			- [Impact](#impact-60)
			- [Recommended Mitigation Steps](#recommended-mitigation-steps-7)
		- [2. Informational - Just-in-time LP provision can be profitable](#2-informational---just-in-time-lp-provision-can-be-profitable)
			- [Impact](#impact-61)
			- [Recommended Mitigation Steps](#recommended-mitigation-steps-8)
			- [Developer response](#developer-response-50)
		- [3. Informational - Potentially misleading description of "no impermanent loss"](#3-informational---potentially-misleading-description-of-no-impermanent-loss)
			- [Impact](#impact-62)
			- [Recommended Mitigation Steps](#recommended-mitigation-steps-9)
			- [Developer response](#developer-response-51)
		- [4. Informational - Miscellaneous](#4-informational---miscellaneous)
			- [Impact](#impact-63)
